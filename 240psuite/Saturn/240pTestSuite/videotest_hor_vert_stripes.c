...
void draw_hor_vert_stripes(video_screen_mode_t screenmode, bool bVertical)
{	
	...
	{
		for (int i=0; i<16; i++)
			_pointer32[i] = 0x01020102;
	}
	else
	{
		for (int i=0; i<4; i++)
		{
			_pointer32[i*4] = 0x01010101;
			_pointer32[i*4+1] = 0x01010101;
			_pointer32[i*4+2] = 0x02020202;
			_pointer32[i*4+3] = 0x02020202;
		}
	}
...
void videotest_hor_vert_stripes(video_screen_mode_t screenmode)
{
	...
	draw_hor_vert_stripes(curr_screenmode,bVertical);
